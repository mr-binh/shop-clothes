    ...
    <div class="cs-invoice cs-style1">
        <div class="cs-invoice_in" id="download_section">
            ...
            -webkit-box-pack: justify;-ms-flex-pack: justify;justify-content: space-between;">
                <div class="cs-invoice_left">
                    <p class="cs-invoice_number cs-primary_color cs-mb5 cs-f16"><b class="cs-primary_color">Invoice
                            No:</b> #SM75692</p>
                    <p class="cs-invoice_date cs-primary_color cs-m0"><b class="cs-primary_color">Date: </b>05.01.2022
                    </p>
                </div>
                <div class="cs-invoice_right cs-text_right">
                    <div class="cs-logo cs-mb5"><img src="{{asset('image/logo.svg')}}"
                                                     alt="Logo"></div>
                </div>
            </div>
            ...
            -webkit-box-pack: justify;-ms-flex-pack: justify;justify-content: space-between;">
                ...
                <div class="cs-invoice_right cs-text_right" style="text-align: right;">
                    <b class="cs-primary_color" style="color: #111111;">Pay To:</b>
                    <p>
                        HB Shop <br>
                        13 Trịnh Văn Bô, Nam Từ Liêm, Hà Nội <br>
                        0819956789 <br>
                        contact@mrbinh.co
                    </p>
                </div>
                        ...
                        <table>
                            ...
                            @if($cart)
                                @foreach($cart as $id => $product)
                                    ...
                                    <tr>
                                        <td class="cs-width_3 cs-text_center">{{$product['name']}}</td>
                                        <td class="cs-width_3 cs-text_center"><p>Color: <span>{{$product['color']}}</span> | Size:
                                                <span>{{$product['size']}}</span></p></td>
                                        <td class="cs-width_1 cs-text_center">{{$product['quantity']}}</td>
                                        <td class="cs-width_2 cs-text_center">{{number_format($product['price'])}} đ</td>
                                        <td class="cs-width_2 cs-text_center">{{number_format($product['price'] * $product['quantity'])}} đ</td>
                                    </tr>
                                @endforeach
                            @endif
                            </tbody>
...
<script src="{{asset('assets/js/oderComfirm/jquery.min.js')}}"></script>
<script src="{{asset('assets/js/oderComfirm/jspdf.min.js')}}"></script>
<script src="{{asset('assets/js/oderComfirm/html2canvas.min.js')}}"></script>
<script src="{{asset('assets/js/oderComfirm/main.js')}}"></script>
@endsection
