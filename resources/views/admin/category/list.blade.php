        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="d-flex justify-content-start">
                    ...
                    <a class="mx-2" href="{{ route('admin.category.show') }}">
            ...
            <div class=" col-lg-6">
                <div class=" d-flex flex-row-reverse bd-highlight">
                    ...
                    <a href="{{ route('admin.category.create') }}" class=" btn btn-primary">Tạo mới thể loại
                    </a>
                </div>
            </div>
        </div>
                            ...
                            <td>
                                <div data-bs-toggle="tooltip" title="Thao tác " class="btn-group dropstart">
                                    ...
                                    <ul class="dropdown-menu  px-4 ">
                                        <li class="my-3">
                                            <a href="{{ route('admin.category.edit', $key->id) }}">
...
{{--                                                $key->posts->count() == 0)--}}
                                                <form action="{{ route('admin.category.destroy', $key->id) }}"
                                                      method="post">
                                                    @csrf
                                                    @method('delete')
...
{{--                                                @endhasrole--}}
            ...
            @else
                <h2>Không tìm thấy thông tin thể loại !!!</h2>
            @endif
