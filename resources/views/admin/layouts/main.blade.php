...
<head>
    <base href="/">
    <title>HB Shop - Trang quản trị shop</title>
    <meta charset="utf-8" />
        ...
        <div class="page d-flex flex-row flex-column-fluid">
            ...
            <div id="kt_aside" class="aside aside-dark aside-hoverable" data-kt-drawer="true"
                ...
                <div class="aside-logo flex-column-auto" id="kt_aside_logo">
                    <!--begin::Logo-->
                    <a href="#">
                        <img alt="Logo" src="{{ asset('admin/assets/media/logos/logo.png') }}" class="h-25px logo" />
                    </a>
                    <!--end::Logo-->
                    <!--begin::Aside toggler-->
                    ...
                    <div
                        ...
                        <div class="text-dark order-2 order-md-1 mx-auto">
                            ...
                            <a href="https://caodang.fpt.edu.vn/" target="_blank"
                                class="text-gray-800 text-hover-primary">By Mr Bình - {{date('Y')}}</a>
                        </div>
                        <!--end::Copyright-->
                        <!--begin::Menu-->
                        <!--end::Menu-->
