    ...
    <div class="container-fluid d-flex align-items-stretch justify-content-between">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="#" class="d-lg-none">
                <img alt="Logo" src="{{ asset('admin/assets/media/logos/logo-poly.png') }}" class="h-30px" />
            </a>
        </div>
        <!--end::Mobile logo-->
        <!--begin::Wrapper-->
            ...
            <div class="d-flex align-items-stretch flex-shrink-0">
                ...
                <div class="d-flex align-items-center ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-30px symbol-md-40px" data-kt-menu-trigger="click"
                        ...
                        <img style="object-fit: cover;" src="{{ auth()->user()->avatar!="" ?auth()->user()->avatar: 'admin/assets/media/avatars/blank.png' }}" alt="user" />
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo"
                                        src="{{ auth()->user()->avatar!="" ?auth()->user()->avatar: 'admin/assets/media/avatars/blank.png' }}" />
                                </div>
                                <!--end::Avatar-->
                                <!--begin::Username-->
