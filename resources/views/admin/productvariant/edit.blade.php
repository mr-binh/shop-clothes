    ...
    <div class="row mb-4">
        <div class="col-lg-12">
            <ol class="breadcrumb text-muted fs-6 fw-bold">
                ...
                <li class="breadcrumb-item px-3 text-muted">Cập nhật thông tin chi tiết sản phẩm</li>
            </ol>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-flush h-lg-100 p-10">
                <form id="formRecruitment" action="{{route('admin.product.detail.update',['id'=>$productvariant->id])}}" method="post"
                    ...
                    <div class="row">
                        <div class="col-8">
                            ...
                            <div class="form-group mb-10">
                                ...
                                <input type="text" name="size" value="{{ $productvariant->size }}"
                                       class="form-control"
                                       placeholder="">
                                @error('size')
                            ...
                            <div class="form-group mb-10">
                                ...
                                <input type="text" name="color" value="{{ $productvariant->color }}"
                                       class="form-control"
                                       placeholder="">
                                @error('color')
                                <p id="checkprice" class="text-danger">{{ $message }}</p>
                            ...
                            <div class="form-group mb-10">
                                ...
                                <input min="0" type="number" name="quantity" value="{{ $productvariant->quantity }}"
                                       class="form-control"
                                       placeholder="">
                                @error('quantity')
                                <p id="checkprice" class="text-danger">{{ $message }}</p>
