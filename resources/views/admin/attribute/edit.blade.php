    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card card-flush h-lg-100 p-10">
                <form id="formRecruitment" action="{{url('admin/attribute').'/'.$type.'/'.$attribute->id}}" method="post"
                        ...
                        <div class="col-8">
                            ...
                            <div class="form-group mb-10">
                                ...
                                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg"
                                    ...
                                    <option value="0" {{ $attribute->attribute_status==0?'selected':''}}>Active</option>
                                    <option value="1"{{ $attribute->attribute_status==1?'selected':''}}>Inactive</option>
                                </select>
                                @error('status')
                            ...
                            @if($type!='banner')
                                <div class="form-group mb-10">
                                    ...
                                    <input type="text" name="attribute_value" value="{{ $attribute->attribute_value }}"
                                           class=" form-control"
                                           placeholder="">
                            ...
                            <div class="col-4">
                                <div class="form-group ">
                                    ...
                                    <img class="w-100 mt-4 border rounded-3" id="image-preview"
                                         src="{{$attribute->attribute_value ? Storage::url($attribute->attribute_value) :'https://vanhoadoanhnghiepvn.vn/wp-content/uploads/2020/08/112815953-stock-vector-no-image-available-icon-flat-vector.jpg'}}"/>
                                </div>
                                @error('image')
                                <p class="text-danger">{{ $message }}</p>
                                @enderror
