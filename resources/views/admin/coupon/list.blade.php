        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="d-flex justify-content-start">
                    ...
                    <a class="mx-2" href="{{ route('admin.coupon.show') }}">
            ...
            <div class=" col-lg-6">
                <div class=" d-flex flex-row-reverse bd-highlight">
                    ...
                    <a href="{{ route('admin.coupon.create') }}" class=" btn btn-primary">Tạo mới mã giảm giá
                    </a>
                </div>
            </div>
        </div>
                ...
                <table class=" table table-hover table-responsive-md text-center">
                    ...
                    @foreach ($coupon as $index => $key)
                        <tr>
                            ...
                            <td>{{number_format($key->discount_max)}} đ</td>
                            <td>
                                {{ $key->quantity}}
                            </td>
                            <td>
...
{{--                                                $key->posts->count() == 0)--}}
                                                <form action="{{ route('admin.coupon.destroy', $key->id) }}"
                                                      method="post">
                                                    @csrf
                                                    @method('delete')
...
{{--                                                </div>--}}
            ...
            @else
                <h2>Không tìm thấy thông tin mã giảm giá !!!</h2>
            @endif
