        ...
        !function () {
            ...
            if (e) {
                var t = e.hasAttribute("data-kt-negative-color") ? e.getAttribute("data-kt-negative-color") : KTUtil.getCssVariableValue("--bs-success"),
                    ...
                    o = KTUtil.getCssVariableValue("--bs-primary"), s = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
    ...
    var e = function (e, t, a, r) {
        ...
        if (i) {
            var o = parseInt(KTUtil.css(i, "height")),
                ...
                }, n = new ApexCharts(i, l), d = !1, c = document.querySelector(e);
...
var KTChartsWidget11 = function () {
    var e = function (e, t, a, r) {
        var i = document.querySelector(t), o = parseInt(KTUtil.css(i, "height"));
        if (i) {
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    i.get("renderer").labels.template.setAll({
                        ...
                        fontSize: 13,
                        fill: am5.color(KTUtil.getCssVariableValue("--bs-gray-500"))
                    }), i.get("renderer").grid.template.setAll({disabled: !0, strokeOpacity: 0}), i.data.setAll(r);
                    var o = a.yAxes.push(am5xy.ValueAxis.new(t, {renderer: am5xy.AxisRendererY.new(t, {})}));
                    o.get("renderer").grid.template.setAll({
                        stroke: am5.color(KTUtil.getCssVariableValue("--bs-gray-300")),
                        strokeWidth: 1,
...
var KTChartsWidget18 = {
    init: function () {
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-900"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), i = {
                        series: [{name: "Net Profit", data: [54, 42, 75, 110, 23, 87, 50]}],
                        ...
                        legend: {show: !1},
                        dataLabels: {enabled: !0, offsetY: -28, style: {fontSize: "13px", colors: [a]}},
                        stroke: {show: !0, width: 2, colors: ["transparent"]},
                        xaxis: {
        ...
        e = document.querySelectorAll(".charts-widget-2"), [].slice.call(e).map((function (e) {
            ...
            if (e) {
                var a = e.getAttribute("data-kt-chart-color"), r = KTUtil.getCssVariableValue("--bs-gray-800"),
                    i = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    o = KTUtil.getCssVariableValue("--bs-" + a), s = KTUtil.getCssVariableValue("--bs-light-" + a),
                    l = new ApexCharts(e, {
        ...
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-500"),
                    ...
                    i = KTUtil.getCssVariableValue("--bs-success"), o = KTUtil.getCssVariableValue("--bs-success"),
                    s = new ApexCharts(e, {
                        series: [{
                            name: "Sales",
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-500"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    i = KTUtil.getCssVariableValue("--bs-primary"), o = KTUtil.getCssVariableValue("--bs-primary"),
                    s = new ApexCharts(e, {
                        series: [{
                            name: "Discounted",
...
var KTChartsWidget7 = function () {
    var e = function (e) {
        ...
        if (t) {
            var a = parseInt(KTUtil.css(t, "height")), r = KTUtil.getCssVariableValue("--bs-border-dashed-color"), i = {
                ...
                colors: [KTUtil.getCssVariableValue("--bs-primary"), KTUtil.getCssVariableValue("--bs-light-primary")],
                grid: {borderColor: r, strokeDashArray: 4, yaxis: {lines: {show: !0}}}
            }, o = new ApexCharts(t, i), s = !1, l = document.querySelector(tabSelector);
...
var KTChartsWidget8 = function () {
    var e = function (e, t, a, r) {
        var i = document.querySelector(t);
        if (i) {
            var o = parseInt(KTUtil.css(i, "height")), s = KTUtil.getCssVariableValue("--bs-border-dashed-color"), l = {
                ...
                chart: {fontFamily: "inherit", type: "bubble", height: o, toolbar: {show: !1}},
                plotOptions: {bubble: {}},
            ...
            }, n = !1, d = new ApexCharts(i, l), c = document.querySelector(e);
        ...
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-400"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    i = KTUtil.getCssVariableValue("--bs-gray-200"), o = KTUtil.getCssVariableValue("--bs-primary"),
                    s = {
            ...
            if ("undefined" != typeof am5) {
                ...
                e && am5.ready((function () {
                    ...
                    i.mapPolygons.template.setAll({
                        ...
                        toggleKey: "active",
                        interactive: !0
                    }), am5.ColorSet.new(t, {}), i.mapPolygons.template.set("fill", am5.color(KTUtil.getCssVariableValue("--bs-primary"))), i.mapPolygons.template.states.create("hover", {fill: t.interfaceColors.get("primaryButtonHover")}), i.mapPolygons.template.states.create("active", {fill: t.interfaceColors.get("primaryButtonHover")}), a.chartContainer.get("background").events.on("click", (function () {
                        a.goHome()
                    })), a.appear(1e3, 100)
                }))
            }
...
var KTSlidersWidget1 = function () {
    var e = function (e, t) {
        ...
        if (a && !a.classList.contains("initialized")) {
            var r = parseInt(KTUtil.css(a, "height")), i = KTUtil.getCssVariableValue("--bs-primary"),
...
var KTSlidersWidget3 = function () {
    var e = function (e, t) {
        var a = document.querySelector(e);
        if (a && !a.classList.contains("initialized")) {
            var r = parseInt(KTUtil.css(a, "height")), i = KTUtil.getCssVariableValue("--bs-gray-500"),
                o = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                s = KTUtil.getCssVariableValue("--bs-danger"), l = KTUtil.getCssVariableValue("--bs-danger");
            new ApexCharts(a, {
                series: [{name: "Sales", data: t}],
    ...
    var e = function (e, t, a, r) {
        ...
        if (i) {
            ...
            var o = {
                ...
                legend: {show: !1},
                fill: {type: "false"}
            }, s = new ApexCharts(i, o), l = !1, n = document.querySelector(e);
    ...
    const r = () => {
        ...
        e.forEach(((e, a) => {
            e.addEventListener("click", (r => {
                ...
                const o = e.closest("tr"), l = ["isOpen", "border-bottom-0"], n = [];
        ...
        !function () {
            ...
            if (e) {
                var t = e.getAttribute("data-kt-chart-color"), a = parseInt(KTUtil.css(e, "height")),
                    ...
                    o = KTUtil.getCssVariableValue("--bs-gray-300"), s = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                ...
                var o = (t.size - t.lineWidth) / 2, s = function (e, t, a) {
    ...
    init: function () {
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")), a = KTUtil.getCssVariableValue("--bs-gray-500"),
                    r = KTUtil.getCssVariableValue("--bs-border-dashed-color"),
                    i = KTUtil.getCssVariableValue("--bs-primary"), o = KTUtil.getCssVariableValue("--bs-gray-300"),
                    s = new ApexCharts(e, {
        ...
        !function () {
            ...
            if (e) {
                var t = parseInt(KTUtil.css(e, "height")),
                    ...
                    r = KTUtil.getCssVariableValue("--bs-light-info"), i = new ApexCharts(e, {
                        series: [{
                            name: "Net Profit",
